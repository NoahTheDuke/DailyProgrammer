...
potentials = []
potentials = [random.randrange(1, type_of_sc_dice + 1) for x in range(num_of_sc_dice)]
print("1d{} sets the Target to {}.".format(target_die, target))
print("{}d{} produces {} to work with.".format(num_of_sc_dice, type_of_sc_dice, potentials))
